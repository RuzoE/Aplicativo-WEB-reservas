{{-- resources/views/admin/minibar/bebida-types-na/edit.blade.php --}}
@extends('layouts.app')
...
@section('title', 'Editar Tipo de Bebida no alcohólica')

@section('content')
<link rel="stylesheet" href="{{ asset('css/blade/admin/minibar/bebida-types-na/edit--style1.css') }}">
...
<div class="form-container">
  ...
  <div class="form-card">
    <div class="form-title">
      ...
      Editar Tipo no alcohólico
    </div>

    <form action="{{ route('admin.minibar.bebida-types-na.update', $bebida_type) }}" method="POST">
      @csrf
      @method('PUT')
