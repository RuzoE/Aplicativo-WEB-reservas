...
@section('content')
<link rel="stylesheet" href="{{ asset('css/blade/admin/minibar/bebida-types/create--style1.css') }}">
...
<div class="form-container">
  ...
  <div class="form-card">
    <div class="form-title">
      ...
      Crear Nuevo Tipo de Bebida
    </div>

    <form action="{{ route('admin.minibar.bebida-types.store') }}" method="POST">
      @csrf
