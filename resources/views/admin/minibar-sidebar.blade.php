<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
  <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
    ...
    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.minibar.dashboard') }}" class="nav-link align-middle px-0">
          <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline">Dashboard</span>
        </a>
      </li>

      <li>
        <a href="{{ route('admin.minibar.ventas.index') }}" class="nav-link px-0 align-middle">
          <i class="fs-4 bi-receipt"></i> <span class="ms-1 d-none d-sm-inline">Ventas</span>
        </a>
      </li>

      <li>
        <a href="{{ route('admin.minibar.bebida-types.index') }}" class="nav-link px-0 align-middle">
          <i class="fs-4 bi-bookmark-fill"></i> <span class="ms-1 d-none d-sm-inline">Tipos Bebida</span>
        </a>
      </li>

      <li>
        <a href="{{ route('admin.minibar.bebidas.index') }}" class="nav-link px-0 align-middle">
