...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadReservations() {
        fetch('{{ route('reception.checkin.search') }}', {
            method: 'POST',
            headers: {
            ...
            if (data.success) {
                ...
                data.reservations.forEach(reservation => {
                    ...
                    html += `<tr>
                        ...
                        <td style="text-align:center"><a href="{{ url('reception/check-in') }}/${reservation.id}" class="btn btn-process"><i class="bi bi-box-arrow-in-right"></i> Procesar</a></td>
                    </tr>`;
                });
