                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="<?php echo e($loop->iteration/10); ?>s">
                    <div class="room-item shadow rounded overflow-hidden">
                        <div class="position-relative image-container">
                            ...
                            text-white rounded py-1 px-3 ms-4"><?php 
                        ...
                        <div class="p-4 mt-2">
                            ...
                            <div class="d-flex justify-content-between">
                                <a class="btn btn-sm btn-primary rounded py-2 px-4"
                                   href="<?php echo e(route('rooms.index')); ?>">Ver detalle</a>
...
<?php /**PATH C:\laragon\www\hotel-piloto-sam\resources\views/sections/room-container-brief.blade.php ENDPATH**/ ?>