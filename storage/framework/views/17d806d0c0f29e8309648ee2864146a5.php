...
<div class="roomtypes-container">
  ...
  <div class="roomtypes-header">
    ...
    <a href="<?php echo e(route('admin.habitaciones.roomtypes.create')); ?>" class="btn-create-type" title="Crear nuevo tipo">
      ...
      <table class="table">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td class="type-number"><?php echo e($loop->iteration); ?></td>
              <td><span class="type-name"><?php echo e($type->name); ?></span></td>
              <td>
                <div class="actions-cell">
                  <a href="<?php echo e(route('admin.habitaciones.roomtypes.edit', ['roomtype' => $type->id])); ?>" class="btn-action btn-edit" title="Editar">
                    <i class="bi bi-pencil-square"></i>
                  </a>
                  <form method="post" action="<?php echo e(route('admin.habitaciones.roomtypes.destroy', ['roomtype' => $type->id])); ?>" style="display: inline;">
                    <?php echo csrf_field(); ?>
  ...
  <?php else: ?>
    <div class="roomtypes-table-card">
      <div class="empty-state-container">
        ...
        <a href="<?php echo e(route('admin.habitaciones.roomtypes.create')); ?>" class="btn-create-first">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-piloto-sam\resources\views/admin/roomtypes/index.blade.php ENDPATH**/ ?>