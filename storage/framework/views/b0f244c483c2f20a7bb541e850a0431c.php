  ...
  <?php if($orders->count() > 0): ?>
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-number"><?php echo e($orders->count()); ?></div>
      ...
      <div class="stat-card">
        ...
        ?>
        <div class="stat-number"><?php echo e('$' . number_format($ingresosCOP, 0, ',', '.')); ?></div>
      ...
      <table class="table">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><span class="room-name"><?php echo e($order->room->roomtype->name); ?></span></td>
              <td class="date-cell">
                <strong><?php echo e($order->check_in->setTimezone('America/Bogota')->format('d/m/Y')); ?></strong>
                <small><?php echo e($order->check_in->setTimezone('America/Bogota')->format('h:i A')); ?></small>
              </td>
              <td class="date-cell">
                <strong><?php echo e($order->check_out->setTimezone('America/Bogota')->format('d/m/Y')); ?></strong>
                <small><?php echo e($order->check_out->setTimezone('America/Bogota')->format('h:i A')); ?></small>
              </td>
              <td class="price-cell"><?php 
...
?></td>
              <td class="reserved-date-cell"><?php echo e($order->created_at->setTimezone('America/Bogota')->format('d/m/Y h:i A')); ?></td>
            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-piloto-sam\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>