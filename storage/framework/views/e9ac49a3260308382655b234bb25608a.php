...
<div class="container-fluid empleados-page">
  ...
  <div id="empleadoFormWrapper" class="card shadow-sm border-0 mb-4 d-none empleado-form-card">
    ...
    <div class="card-body p-4">
      <form action="<?php echo e(route('admin.empleados.store')); ?>" method="POST" autocomplete="off" id="empleadoCreateForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
          ...
          <div class="row g-3">
            <?php $__currentLoopData = $rolesCreate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $rname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-md-6">
                <label class="role-card-custom p-3 border rounded-2 d-flex align-items-center gap-3" style="cursor:pointer;transition:all .2s">
                  <input type="radio" name="role_id" value="<?php echo e($id); ?>" class="form-check-input" style="width:20px;height:20px" required>
                  <div>
                    <div class="fw-bold text-capitalize" style="font-size:1rem">
                      <?php if($rname === 'reservas'): ?>
                        <i class="bi bi-calendar-event me-2 text-warning"></i>Reservas
                      <?php elseif($rname === 'recepcion'): ?>
  ...
  <div id="empleadosTableWrapper" class="card shadow-sm border-0">
    <div class="card-body p-0">
      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0 empleados-table">
          ...
          <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td class="px-3 fw-semibold"><?php echo e($u->id); ?></td>
              <td><?php echo e($u->name); ?><?php echo e($u->last_name ? ' '.$u->last_name : ''); ?></td>
              ...
              <td class="roles-cell">
                ...
                <?php else: ?>
                  <?php $__currentLoopData = $names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="badge rounded-pill role-badge-<?php echo e($r); ?> me-1"><?php echo e(ucfirst($r)); ?></span>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              </td>
              <td class="text-end">
                <form action="<?php echo e(route('admin.empleados.roles.assign', $u)); ?>" method="POST" class="d-inline-flex gap-2 align-items-center">
                  <?php echo csrf_field(); ?>
                  <select name="role" class="form-select form-select-sm w-auto" required>
                    <option value="" disabled selected>Elegir…</option>
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($rname); ?>"><?php echo e(ucfirst($rname)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
              ...
              <td class="text-center">
                <?php if($u->id !== auth()->id()): ?>
                  <form action="<?php echo e(route('admin.empleados.destroy', $u)); ?>" method="POST"
                        onsubmit="return confirm('¿Estás seguro de eliminar a <?php echo e($u->name); ?>?');">
                    <?php echo csrf_field(); ?>
    ...
    <?php if($empleados instanceof \Illuminate\Contracts\Pagination\Paginator): ?>
...
<script src="<?php echo e(asset('js/admin-empleados-form.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-piloto-sam\resources\views/admin/empleados/index.blade.php ENDPATH**/ ?>